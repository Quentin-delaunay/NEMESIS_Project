...
max_peak_power = col1.number_input("Maximum Power Peak (MW)", min_value=5000, max_value=20000, value=16300, step=500, key="peak_power")
...
if view == "Filtered Data Visualization":
    ...
    if st.button("Save Data for Pandapower Network with Urban Areas"):
        output_folder = "Main_app/output_pandapower/"
        ...
        for _, area in high_pop_areas.iterrows():
            ...
            if not intersecting_buses.empty:
                ...
                load_per_bus = (area['POP2010'] / total_population) # fractional load per bus
        ...
        from utils import create_network_from_filtered_data  # Ensure this function is in your utils.py
